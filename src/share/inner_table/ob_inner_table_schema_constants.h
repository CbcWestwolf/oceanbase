...
const uint64_t OB_ALL_EXTERNAL_TABLE_TID = 308; // "__all_external_table"
...
const uint64_t OB_ALL_VIRTUAL_EXTERNAL_TABLE_TID = 12207; // "__all_virtual_external_table"
...
const char *const OB_ALL_EXTERNAL_TABLE_TNAME = "__all_external_table";
...
const char *const OB_ALL_VIRTUAL_EXTERNAL_TABLE_TNAME = "__all_virtual_external_table";
