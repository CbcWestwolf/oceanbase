...
struct ALL_VIRTUAL_PS_STAT_CDE {
  enum { TENANT_ID = common::OB_APP_MIN_COLUMN_ID, SVR_IP, SVR_PORT, STMT_COUNT, HIT_COUNT, ACCESS_COUNT, MEM_HOLD };
};
...
public:
  ...
  static int all_virtual_tenant_security_audit_history_real_agent_ora_schema(
  ...
  static int all_virtual_tenant_time_zone_transition_type_real_agent_ora_schema(
      share::schema::ObTableSchema& table_schema);
  ...
  static int all_virtual_plan_cache_stat_all_virtual_plan_cache_stat_i1_schema(
      share::schema::ObTableSchema& table_schema);
  ...
  static int all_virtual_session_wait_history_all_virtual_session_wait_history_i1_schema(
      share::schema::ObTableSchema& table_schema);
  ...
  static int all_virtual_sql_plan_monitor_all_virtual_sql_plan_monitor_i1_schema(
      share::schema::ObTableSchema& table_schema);
  static int all_virtual_sql_audit_ora_all_virtual_sql_audit_i1_schema(share::schema::ObTableSchema& table_schema);
  static int all_virtual_plan_cache_stat_ora_all_virtual_plan_cache_stat_i1_schema(
      share::schema::ObTableSchema& table_schema);
  static int all_virtual_session_wait_ora_all_virtual_session_wait_i1_schema(
      share::schema::ObTableSchema& table_schema);
  static int all_virtual_session_wait_history_ora_all_virtual_session_wait_history_i1_schema(
      share::schema::ObTableSchema& table_schema);
  ...
  static int all_virtual_system_event_ora_all_virtual_system_event_i1_schema(
      share::schema::ObTableSchema& table_schema);
...
const uint64_t restrict_access_virtual_tables[] = {OB_ALL_VIRTUAL_SQL_AUDIT_ORA_TID,
    OB_ALL_VIRTUAL_PLAN_STAT_ORA_TID,
    OB_ALL_VIRTUAL_PLAN_CACHE_PLAN_EXPLAIN_ORA_TID,
    OB_ALL_VIRTUAL_PLAN_CACHE_STAT_ORA_TID,
    OB_ALL_VIRTUAL_SESSION_WAIT_ORA_TID,
