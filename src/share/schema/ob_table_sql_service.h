...
private:
  ...
  int delete_from_all_external_table(
      common::ObISQLClient& sql_client, const uint64_t tenant_id, const uint64_t table_id);
...
public:
  ...
  int insert_external_table_info(common::ObISQLClient& trans, const ObTableSchema& table_schema);
