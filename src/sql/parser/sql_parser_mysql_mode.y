...
/*Please add the newly added non-reserved keywords to the corresponding rows in alphabetical order, thanks! ! !*/
        ...
        EXTENDED_NOADDR EXTENT_SIZE EXTRACT EXCEPT EXPIRED EXTERNAL EXTERNAL_URL EXTERNAL_DELIMITERS EXTERNAL_PROTOCAL EXTERNAL_FORMAT
...
| EXTERNAL_DELIMITERS opt_equal_mark STRING_VALUE
{
  (void)($2);
  malloc_non_terminal_node($$, result->malloc_pool_, T_EXTERNAL_DELIMITERS, 1, $3);
}
